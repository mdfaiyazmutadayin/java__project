...
public class GraphicsU extends JFrame implements ActionListener{   
...
mb.add(accessories);  
	...
	icon= new ImageIcon(getClass().getResource("photo//graphicscardicon.png"));
		this.setIconImage(icon.getImage());

img= new ImageIcon(getClass().getResource("photo//graphicsportal.png"));
  ...
  Object row[][] = {
	                        {"Graphics Crad-#44","Colorful GeForce GT710-2GD3-V 2GB Graphics Card"," 27,500/="},
			                {"Graphics Crad-#43","GIGABYTE GeForce GT 730 2GB DDR3 PCI EXPRESS "," 47,500/="},
			                {"Graphics Crad-#33","Asus Geforce Gt 730 2GB GDDR5"," 7,500/="},
			                {"Graphics Crad-#32","GIGABYTE GeForce GT 1030 Low Profile D4 "," 9,500/="},
			                {"Graphics Crad-#17","NVIDIA Quadro P1000 4GB GDDR5 "," 50,500/="},
			                {"Graphics Crad-#16","GIGABYTE GeForce GTX 1650 D6 OC Low Profile 4GB GDDR6"," 18,500/="},
			                {"Graphics Crad-#11","ASRock Intel Arc A380 Challenger ITX 6GB OC GDDR6"," 19,500/="},
			                {"Graphics Crad-#08","Zotac Gaming GeForce GTX 1650 OC 4GB GDDR6"," 21,500/="},
			                {"Graphics Crad-#09","GIGABYTE Radeon RX 6500 XT EAGLE 4GB GDDR6"," 30,500/="},
			                {"Graphics Crad-#17","SAPPHIRE PULSE AMD Radeon RX 6650 XT 8GB GDDR6 "," 90,500/="},
			                {"Graphics Crad-#38","XFX Speedster QICK 319 AMD Radeon RX 6800 Core 16GB GDDR6"," 80,500/="}
