...
img= new ImageIcon(getClass().getResource("photo//keyboardportal.png"));
  ...
  Object row[][] = {
			                {"Keyboard-#12","AULA S2022 Mechanical Wired Gaming Keyboard"," 2000/="},
			                {"Keyboard-#2","Micropack GK-20 APOLLO RGB Gaming Keyboard"," 2,200/="},
			                {"Keyboard-#13","Havit HV-KB858L RGB Backlit Mechanical Gaming Keyboard "," 2,500/="},
			                {"Keyboard-#14","Keychron Wooden Palm Rest For K2/K6"," 2,800/="},
			                {"Keyboard-#15","A4TECH Fstyler FBX51C Rechargeable Bluetooth "," 2,500/="},
			                {"Keyboard-#26","Rapoo 9000M Multi-mode Wireless Ultra-slim Keyboard"," 3,000/="},
			                {"Keyboard-#27","Logitech K380 Bluetooth Multi-Device Keyboard"," 3800/="},
			                {"Keyboard-#28","MotoSpeed CK107 (K96) Wired Mechanical Backlit Keyboard "," 3800/="},
			                {"Keyboard-#29","A4TECH Bloody S510N Mechanical Brown Switch RGB Gaming Keyboard"," 3,200/="},
			                {"Keyboard-#30","Apple Magic Keyboard"," 18000/="},
			                {"Keyboard-#81","Corsair K95 RGB Platinum Mechanical Gaming Keyboard "," 18500/="},
			                {"Keyboard-#42","Asus ROG Strix Flare XA01 Cherry MX Brown Switch RGB "," 22000/="},
