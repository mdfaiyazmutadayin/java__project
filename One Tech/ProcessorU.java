...
public class ProcessorU extends JFrame implements ActionListener{   
...
mb.add(accessories);  
	...
	icon= new ImageIcon(getClass().getResource("photo//processoricon.png"));
...
img= new ImageIcon(getClass().getResource("photo//processorportal.png"));
  ...
  Object row[][] = {
			                ...
			                {"Processor-#002"," AMD Ryzen 5 5500 3.6GHz-4.2GHz 6 Core 19MB Cache AM4 Socket Processor"," 25,000/="},
			                ...
			                {"Processor-#005","AMD Ryzen Threadripper 1900X 3.8-4.0GHz 8 Core 16"," 25,000/="},
			                {"Processor-#006"," Intel Alder Lake Pentium Gold G7400 Socket Processor"," 35,000/="},
