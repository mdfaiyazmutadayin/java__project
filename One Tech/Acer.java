...
public class Acer extends JFrame implements ActionListener{   
...
img= new ImageIcon(getClass().getResource("photo//acerportal.png"));
  ...
  Object row[][] = {
			                {"L-Acer#461","Acer TravelMate TMP214-53 ","1,10,000/="},
			                {"L-Acer#902","Acer Aspire 7 A715-5G","1,20,000/="},
			                {"L-Acer#803","Acer Aspire 7 A715-42G-R2NE Ryzen 5","1,30,000/="},
			                {"L-Acer#055","Acer Nitro 5 AN515-58-58TZ Core i5 ","1,40,000/="},
			                {"L-Acer#125","Acer Predator Helios 300 PH315-54-736E ","1,50,000/="},
			                {"L-Acer#156","Acer Predator Helios 300 PH315-54-77MK Core i7 ","1,60,000/="},
			                {"L-Acer#007","Acer Predator PH315-53 Intel Core i7 ","1,70,000/="},
			                {"L-Acer#008","Acer Predator PH315-53 Intel Core I7-10870H","1,80,000/="},
			                {"L-Acer#609","Acer Predator PH315","1,45,000/="},
			                {"L-Acer#560","Acer Predator Heilos","1,56,000/="},
			                {"L-Acer#061","Acer Extensa 15 EX215-54-596B ","1,90,000/="}
