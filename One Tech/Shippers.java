...
public class Shippers extends JFrame implements ActionListener{
    ...
    Shippers(){
        ...
        logoutb.setBounds(50,520,50,50);
        ...
        refreshb.setBounds(0,100,100,100);
        ...
        updateb.add(updatel);
        updateb.setBounds(0,300,100,100);
        ...
        deleteb=new JButton();
        deleteb.add(deletel);
        deleteb.setBounds(0,400,100,100);
        ...
        pane.setBounds(100,0,700,600);
        table.setBackground(Color.GRAY);
        table.setForeground(Color.black);
        table.setRowHeight(50);
        
        this.setTitle("Shippers");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==addb){
			dispose();
            AddShippers sh11=new AddShippers();
        }
