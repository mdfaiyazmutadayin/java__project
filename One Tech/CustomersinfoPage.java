...
public class CustomersinfoPage extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource()==refresh){
            String filePath = "customersinfo.txt";
    ...
    public static void main(String [] args){
        CustomersinfoPage eml1 =new CustomersinfoPage();
    }
